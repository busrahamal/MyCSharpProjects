...
namespace OgrenciSinavNotUygulamasi
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Double değer, console ekranında klavyeden girlirse virgülle, kod ekranından girilirse nokta ile girilmelidir. 
            // Console ekranında virgül yerine nokta koyarsak sayıyı bir bütün olarak algılar. Örn: 4.32 yazınca 432 çıktısı verir. 
